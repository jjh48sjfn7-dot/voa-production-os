...
export const lightingDmxSignalFlowDocument: LightingDmxSignalFlowDocument = {
  ...
  signalPath: {
    ...
    nodes: [
      { id: "foh-mac", name: "FOH Mac Desktop", emoji: "💻" },
      { id: "lightkey", name: "Lightkey", emoji: "🎛️" },
      { id: "dmxking", name: "DMXking Micro", emoji: "🔌" },
      { id: "universe-1", name: "Universe 1", emoji: "📡" },
      { id: "floor-3", name: "Floor 3 — Stage Right", emoji: "💡" },
      { id: "floor-2", name: "Floor 2 — Center", emoji: "💡" },
      { id: "floor-1", name: "Floor 1 — Stage Left", emoji: "💡" },
      { id: "tr-1", name: "TR-1", emoji: "💡" },
      { id: "tr-2", name: "TR-2", emoji: "💡" },
      { id: "tr-3", name: "TR-3", emoji: "💡" },
      { id: "tr-4", name: "TR-4", emoji: "💡" },
      { id: "tr-5", name: "TR-5", emoji: "💡" },
      { id: "tr-6", name: "TR-6", emoji: "💡" },
    ],
  },
  teardownNote:
