...
export const inventoryItems: InventoryEntry[] = [
  ...
  { id: "inv-wireless", assetNumber: "VOA-ANT-AUD-004", name: "Shure BLX288 Dual Receiver", category: "Wireless", quantity: 2, location: "FOH Rack — Wireless", status: "in-use", condition: "good", lastService: "Aug 2026", nextService: "Feb 2027" },
  ...
  { id: "inv-snake-a", assetNumber: "VOA-ANT-AUD-030", name: "Stage Snake A", category: "Stage Snakes", quantity: 1, location: "Stage Left → FOH", status: "in-use", condition: "excellent", lastService: "Jul 2026", nextService: "Jan 2027" },
  { id: "inv-snake-b", assetNumber: "VOA-ANT-AUD-031", name: "Stage Snake B", category: "Stage Snakes", quantity: 1, location: "Stage Right → FOH", status: "in-use", condition: "excellent", lastService: "Jul 2026", nextService: "Jan 2027" },
  ...
  { id: "inv-sub", assetNumber: "VOA-ANT-AUD-072", name: "Subwoofer", category: "Speakers", quantity: 1, location: "FOH — Center", status: "in-use", condition: "excellent", lastService: "Jun 2026", nextService: "Dec 2026" },
  { id: "inv-pm1", assetNumber: "VOA-ANT-AUD-073", name: "Behringer PM1 (Drummer In-Ear)", category: "Monitors", quantity: 1, location: "Stage Left — Drum kit", status: "in-use", condition: "excellent", lastService: "Jun 2026", nextService: "Dec 2026" },
];
...
export const inventoryBlocks: ContentBlock[] = [
  {
    ...
    items: [
      ...
      { id: "inv-check-batteries", label: "Wireless — fresh AA installed in all handhelds" },
