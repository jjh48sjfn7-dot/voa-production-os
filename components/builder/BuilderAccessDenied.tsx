...
const deniedCopy = {
  ...
  multiple: {
    ...
    body: "Builder configuration needs a single active church team. A workspace switcher is not available yet.",
  },
  not_builder: {
    title: "Builder access required",
    body: "This page is limited to people with an explicit Builder permission for this church team.",
  },
  unavailable: {
...
export function BuilderAccessDenied({
  reason,
}: {
