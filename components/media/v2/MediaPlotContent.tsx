...
import { mediaPlotDocument } from "@/data/media/v2/media-plot";
import { audioStyles } from "@/lib/audio-styles";

export function MediaPlotContent() {
  ...
  return (
    <div>
      ...
      <p className={`mt-2 ${audioStyles.body} text-slate-500`}>
        {mediaPlotDocument.subtitle}
      </p>

      <div className="mt-6 space-y-8 sm:mt-8 sm:space-y-10">
        <EquipmentSection title={mediaPlotDocument.intro.title}>
          <DocumentationInfoCard body={mediaPlotDocument.intro.body} />
        </EquipmentSection>

        <EquipmentSection title="Media layout">
          <ChurchBlueprint
