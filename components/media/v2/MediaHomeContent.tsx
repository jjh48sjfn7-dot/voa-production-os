...
import { mediaTodaysService, mediaTools } from "@/data/media/v2/home";
import { audioStyles } from "@/lib/audio-styles";

export function MediaHomeContent() {
  return (
    <div className="space-y-10 md:space-y-12">
      <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
        <Breadcrumbs items={[{ label: "Media Department" }]} />
        <Link
          href="/"
      ...
      <DashboardSection title="Today's Service">
        <DashboardRow
          href={mediaTodaysService.href}
          icon={BookOpen}
          accent="media"
          description={mediaTodaysService.description}
          title={mediaTodaysService.title}
        />
      </DashboardSection>

      <DashboardSection title="Media Tools">
