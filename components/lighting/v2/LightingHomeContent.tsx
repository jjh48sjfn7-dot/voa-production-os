...
import { lightingTodaysService, lightingTools } from "@/data/lighting/v2/home";
import { audioStyles } from "@/lib/audio-styles";

export function LightingHomeContent() {
  return (
    <div className="space-y-10 md:space-y-12">
      <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
        <Breadcrumbs items={[{ label: "Lighting Department" }]} />
        <Link
          href="/"
      ...
      <DashboardSection title="Today's Service">
        <DashboardRow
          href={lightingTodaysService.href}
          icon={BookOpen}
          accent="lighting"
          description={lightingTodaysService.description}
          title={lightingTodaysService.title}
        />
      </DashboardSection>

      <DashboardSection title="Lighting Tools">
